...
#define GPIO_IN_MAXM8C_DATAREADY_Pin GPIO_PIN_2
#define GPIO_IN_MAXM8C_DATAREADY_GPIO_Port GPIOF
#define GPIO_IN_BM1422AGMV_DATAREADY_Pin GPIO_PIN_3
#define GPIO_IN_BM1422AGMV_DATAREADY_GPIO_Port GPIOF
#define GPIO_IN_BMI323_DATAREADY_Pin GPIO_PIN_3
#define GPIO_IN_BMI323_DATAREADY_GPIO_Port GPIOB
#define GPIO_IN_ADXL375_DATAREADY_Pin GPIO_PIN_5
#define GPIO_IN_ADXL375_DATAREADY_GPIO_Port GPIOB
